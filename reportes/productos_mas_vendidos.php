...
<div class="container-fluid">
  <div class="row">
    <div class="col-12 bg-ligth text-white text-center p-3 mb-4" style="background-color:	#ffff(0, 0, 0);">
       <div class="d-flex justify-content-between align-items-center">
        ...
        <!-- TÍTULO centrado -->
      <h2 class="m-0 text-center felx-grow-1 text-dark">Productos mas Vendidos</h2>
